...
class THORUS{
  ...
  th = function(elementHTML , elementRef , ui){
    ...
    var th_proto = {
      ...
      active : false,
      //
      "_css" : ("prop" in elementRef && "style" in elementRef.prop ? (function(ref){
      ...
      //
      activeStyle : ("prop" in elementRef && "activeStyle" in elementRef.prop ? (function(ref){
      ...
      //
      hoverStyle : ("prop" in elementRef && "hoverStyle" in elementRef.prop ? (function(ref){
      ...
      turnActive : function() {
        ...
        if(element.active.get() == false){
          ...
          if(Object.keys(self.hoverStyle.get()).length > 0)self.Style()["@onActive"]();
          ...
          if(Object.keys(self.hoverStyle.get()).length > 0)self.Style()["@onUnactive"]();
      ...
      Style : function(arg = null){
        ...
        function style(cssArg,_self){
          ...
          this.__proto__.Reset = function(){
            if("_css" in this.element.th)this.element.th.Style(this.element.th._css.get());
          }
          ...
          this.__proto__["@onActive"] = function(){
            ...
            if("activeStyle" in this.element.th)this.element.th.Style().Add(this.element.th.activeStyle.get())
          }
          ...
          this.__proto__["@onUnactive"] = function(){
            ...
            for(const e of this.element.th.cssStates().History()){
              ...
              else this.element.th.Style().Add(this.element.th[`${e}Style`].get());
            }
          }

          this.__proto__["@onHover"] = function(){
            this.element.th.cssStates().push('hover');
            if("hoverStyle" in this.element.th)this.element.th.Style().Add(this.element.th.hoverStyle.get())
          }
      ...
      cssStates : function(){
        return new (function(_this){
          ...
          this.__proto__.History = function(){
            return _this._cssStates.get().history;
          }

          this.__proto__.push = function(arg){
            let states = _this._cssStates.get();
          ...
          this.__proto__.Current = function(){
            return _this._cssStates.get().current;
          }

          this.__proto__.Last = function(){
            return _this._cssStates.get().last;
          }
...
*/
    var th_handlers = {
      ...
      mouseenter : function(e = null){ // fonction d'entrée du curseur sur l'élément
        ...
        if(Object.keys(self.hoverStyle.get()).length > 0)self.Style()["@onHover"]();
      ...
      mouseleave : function(e = null){ // fonction de sortie du curseur sur l'élément
        ...
        if(Object.keys(self.hoverStyle.get()).length > 0)self.Style()["@onUnhover"]();
  ...
  */
  Var = function(x = null , o){
    if(!o)o = {};
    if('writable' in o == false)o.writable = false;
    ...
    function Var(value , options){
      ...
      this.__proto__.Type = function(v){
        if(!v)return null;
        else if(typeof v == 'object'){ // si value est un "object"
