...
class THORIUM_ENGINE{
  ...
  constructor(){
    ...
    window.cssSheet = function(element = null , arg = null){
      return self.cssSheet(element,arg);
    }
    window.cssStyle = function(cssDef = null){
      return self.cssStyle(cssDef);
    }
...
THORIUM_ENGINE.prototype.cssSheet = function (element = null , propName = null) {
  try{
...
THORIUM_ENGINE.prototype.cssStyle = function (cssDef = null) {
  return Array.from({length : Object.keys(cssDef).length } , function(x,i){
    return `${Object.keys(cssDef)[i]}:${Object.values(cssDef)[i]};`
  }).join('');
}
...
class DropDown extends thorium.components{
  constructor(arg){
    super({
      type : 'dropDown',
      prop : {id : ('id' in arg ? arg.id : '')},
      childrens : [
        new Input({prop:{id : 'dropResult' , placeholder : ('placeholder' in arg ? arg.placeholder : '' )}}),
        new Container({
          prop : {id : 'DropResContainer'}
        })
      ],
      proto : {
        ...
        onMouseEnter : function(){this.turnActive();},
        onMouseLeave : function(){this.turnActive();}
      }
    })
  }
}
