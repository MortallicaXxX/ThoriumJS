...
UIelement.prototype.normalise = async function(definition = {}) {
  ...
  try{ // rejet si différent de type Object
    ...
    if(Array.isArray(definition))throw {err:2,msg:"value est un tableau",value:definition,isArray:Array.isArray(definition),typeof:typeof definition};
...
class THORIUM_ENGINE{
  ...
  constructor(){
    ...
    window.onload = async function(){
      ...
      if(self.onReady)return self.onReady(self);
      else ready();
